...
const ChangePasswordFormApi = process.env.REACT_APP_API_CHANGE_PASSWORD;
...
const ChangePasswordForm = () => {
  ...
  const handleChangePasswordForm = async () => {
    ...
    try {
      ...
      const response = await axios.put(`${ChangePasswordFormApi}/${userId}`, {
      ...
      <Form>
        ...
        <Row className="align-items-center">
          <Col xs={12} md={6} className="text-center text-md-start mb-2 mb-md-0">
            ...
            <Button variant="primary" className="px-4 w-100" onClick={handleChangePasswordForm} disabled={loading}>
